...
func CreateItemObject(args []string) (ItemObject, error) {
	...
	imagePath := "/tmp/" + args[9]
        imageFile, err := os.Create("/tmp/image.jpg")
        imageFile.WriteString(imageContent)
